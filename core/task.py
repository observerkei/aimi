    ...
    def make_link_think(
        ...
        settings: Dict = {
            ...
            "preset_rule": [
                ...
                f"4. 回复格式: 如你在模拟/扮演 A 的时候, 我的提问都是针对模拟对象, 在模拟对象模式的时候, 你要模拟所有需要模拟的对象, 如有两个对象 a 和 b , 则设置 `进入模拟 [a] [b] 对象模式`, 这时候需要同时模拟多个对象一起说话. "
                f"直到 Master 说退出为止, 如我问: `你是谁`, 你回答: `[a] 我是 a \n[b] 我是 b ` ",
                ...
                f"6. 在模拟对象模式时自身出现的时机: 你在 模拟对象模式 的时候, 除非我要找 {aimi_core_name}, 否则你不应该主动出来, 你会始终保障系统稳定运行的情况下 才能完成对象模拟. "
